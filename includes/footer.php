...
<!-- SCRIPT PARA SELECIONAR ARMARIO DE ACORDO COM CONDOMINIO -->
...
//Essa funcao aqui retira a opcao da lista de select
$("#lista-cadastros").find("td:nth-child(2)").each(function(){
  cadastro = $(this).html();
  console.log(cadastro);
  $("option[value='"+cadastro+"']").remove();
})
</script>
